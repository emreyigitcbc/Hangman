...
function getStatus()
{
    ...
    <div id="info">
        <div class="text">
			...
			<button class="info-button" onclick="location.href = \'?p=new\';">NEW GAME</button>
		</div>
	</div>
';
...
function getHint()
{
    echo "<span class='hint-title'>Hint:</span> <span class='hint'>" . $_SESSION["hint"] . "</span>";
}
...
<html>
<head>
<title>Hangman - EmreCebeci</title>
...
switch ($_GET["p"]) {
    ...
    case "enter":
        ...
        // Check every letter.
        for ($i = 0; $i < $_SESSION["word-lenght"]; $i ++) {
            if (strtolower($_SESSION["displayletter_" . $i]) != strtolower($pressed)) {
                ...
                if (strtolower($pressed) == strtolower($_SESSION["word"][$i])) {
                    ...
                    $_SESSION["displayletter_" . $i] = strtoupper($_SESSION["letter_" . $i]);
                    $_SESSION["confirms"] += 1;
                    $checks -= 1;
                }
            } else {
...
?>
	...
	<div id="footer">
		<div class="footer-links">
			...
			<ul>
				<li><a href="https://github.com/emreyigitcbc">GitHub Profile</a></li>
				<li><a href="https://github.com/emreyigitcbc/HangMan">GitHub Rep.</a></li>
			</ul>
		</div>
		<div class="copy">Author: Emre Cebeci, version: 1.3</div>
	</div>
</body>
</html>